...
public class Shop_Clothes_Fragment extends ShopValues {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = LayoutInflater.from(getContext()).inflate(R.layout.fragment_shop_clothes_, null);
        ...
        NAME_VIEW.setText(clothes_name[0]);
        CONTENT_VIEW.setText(clothes_content[0]);
        PRICE_VIEW.setText(String.valueOf(clothes_price[0]));
...
//
        ...
        Slot2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Number[0] = 1;
                NAME_VIEW.setText(clothes_name[1]);
                CONTENT_VIEW.setText(clothes_content[1]);
                PRICE_VIEW.setText(String.valueOf(clothes_price[1]));
            }
        });
        Slot3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Number[0] = 2;
                NAME_VIEW.setText(clothes_name[2]);
                CONTENT_VIEW.setText(clothes_content[2]);
                PRICE_VIEW.setText(String.valueOf(clothes_price[2]));
            }
        });
        Slot4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Number[0] = 3;
                NAME_VIEW.setText(clothes_name[3]);
                CONTENT_VIEW.setText(clothes_content[3]);
                PRICE_VIEW.setText(String.valueOf(clothes_price[3]));
            }
        });
        Slot5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Number[0] = 4;
                NAME_VIEW.setText(clothes_name[4]);
                CONTENT_VIEW.setText(clothes_content[4]);
                PRICE_VIEW.setText(String.valueOf(clothes_price[4]));
            }
        });
        Slot6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Number[0] = 5;
                NAME_VIEW.setText(clothes_name[5]);
                CONTENT_VIEW.setText(clothes_content[5]);
                PRICE_VIEW.setText(String.valueOf(clothes_price[5]));
            }
        });
        ...
        BUY.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PURCHASE(clothes[Number[0]], clothes_price[Number[0]], "clothes_num_" + Number[0], Money_View);
            }
        });
        return v;
    }
    ...
    private void FillChanged(final TextView Money_View) {
        ...
        for (int i = 0; i < 6; i++)
            clothes[i] = pref.getInt("clothes_num_" + i, 0);
